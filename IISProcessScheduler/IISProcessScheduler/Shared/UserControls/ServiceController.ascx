<%@ Control EnableViewState="false" Language="C#" AutoEventWireup="true" CodeBehind="ServiceController.ascx.cs" EnableTheming="true" Inherits="IISProcessScheduler.Shared.UserControls.ServiceController" %>
